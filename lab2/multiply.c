...
void *thread_function(void *arg)
{
	...
	// exterior for on threads - exercise 3
	...
	// second for on threads - exercise 4
	...
	// third for on threads - exercise 5
